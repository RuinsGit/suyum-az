                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="main_image_meta_title_az" 
                                                       value="{{ old('main_image_meta_title_az', $product->main_image_meta_title_az) }}" 
                                                       class="form-control">
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="main_image_meta_description_az" 
                                                          class="form-control" 
                                                          rows="3">{{ old('main_image_meta_description_az', $product->main_image_meta_description_az) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="main_image_meta_title_en" 
                                                       value="{{ old('main_image_meta_title_en', $product->main_image_meta_title_en) }}" 
                                                       class="form-control">
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="main_image_meta_description_en" 
                                                          class="form-control" 
                                                          rows="3">{{ old('main_image_meta_description_en', $product->main_image_meta_description_en) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="main_image_meta_title_ru" 
                                                       value="{{ old('main_image_meta_title_ru', $product->main_image_meta_title_ru) }}" 
                                                       class="form-control">
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="main_image_meta_description_ru" 
                                                          class="form-control" 
                                                          rows="3">{{ old('main_image_meta_description_ru', $product->main_image_meta_description_ru) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
