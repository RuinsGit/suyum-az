        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tərcümə əlavə et</h4>
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('admin.setting.store') }}"
                                        ...
                                        <div class="tab-pane active" id="az">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="value_az" class="form-control">{{ old('value_az') }}</textarea>
                                                    @error('value_az')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="en">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="value_en" class="form-control">{{ old('value_en') }}</textarea>
                                                    @error('value_en')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="ru">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="value_ru" class="form-control">{{ old('value_ru') }}</textarea>
                                                    @error('value_ru')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
